...
/**
 * Criteria class for the {@link com.mgs.aan.domain.State} entity. This class is used
 * in {@link com.mgs.aan.web.rest.StateResource} to receive all the possible filtering options from
...
public class StateCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, createdAt, createdBy, updatedAt, updatedBy, active, districtId, userLocationId, countryId, distinct);
    }
